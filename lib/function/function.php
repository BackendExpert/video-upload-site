<?php 
    ...
    function update_bio(){
        ...
        if($select_row['bio_status'] == 0){
            $my_bio = "
                <a href=''><button class='btn btn-warning'>Add Bio</button></a> <p style='color:red;'>Update Your Bio</p>            
            ";
        }
        else{
            $my_bio = "bio Updated";
    ...
    function update_channel_info(){
        ...
        if($select_row['channel_status'] == 0){
            $ch_bio = "
                <a href=''><button class='btn btn-warning'>Add Channel Info</button></a> <p style='color:red;'>Update Your Channel Info</p>            
            ";
        }
        else{
            $ch_bio = "bio Updated";
