    ...
    function sign_up($username, $email, $pass, $cpass){
        ...
        elseif($pass != $cpass){
            ...
            if($check_user_nor > 0){
                ...
                $insert_user = "INSERT INTO user_tbl(username,email,user_pass,user_type,is_active,is_un_access,join_at,update_at)VALUES('$username','$email','$pass','user',0,0,NOW(),NOW())";
